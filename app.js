...
*/
const newPokemon = pokemon.filter (item => {
    return item.type === "grass" && item.hp === 60;
});
...
*/
const evolvedPokemon = pokemon.filter (value => ["Ivysaur", "Charmeleon", "Wartortle", "Raichu"].includes(value.name));
 game.party.splice (0, game.party.length, evolvedPokemon);
 console.log(game.party); 
